...
export class MainStack extends Stack {
  constructor(scope: Construct, id: string, props: MainStackProps) {
    ...
    // APIドメイン
    const apiDomainName = `api.${props.appDomainName}`;
    ...
    if (props.isSesEnabled) {
      ...
      new ses.EmailIdentity(
        ...
        "EmailIdentity",
        {
          ...
          mailFromDomain: `bounce.${props.appDomainName}`,
        },
      );
      ...
      new route53.TxtRecord(
        ...
        {
          zone: hostedZone,
          recordName: `_dmarc.${props.appDomainName}`,
      ...
      console.log(
        `Skipping SES Identity and DMARC Record creation as isSesEnabled is false.`,
      );
    }

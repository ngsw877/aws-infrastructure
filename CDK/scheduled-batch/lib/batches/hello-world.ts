    ...
    const helloWorldLambda = new NodejsFunction(
      ...
      "HelloWorldLambda",
      {
        ...
        environment: {
          ...
          BATCH_SUCCESS_WEBHOOK_PARAMETER_STORE_NAME: props.batchSuccessWebhookParameterStoreName,
          BATCH_FAILURE_WEBHOOK_PARAMETER_STORE_NAME: props.batchFailureWebhookParameterStoreName,
        },
      },
    );
